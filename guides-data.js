...
const guides = [
  ...
  content: `
    ...
    <div class="guide-images">
      <img src="images/guides/turn-1.png" alt="턴 시스템 1">
      <img src="images/guides/turn-2.png" alt="턴 시스템 2">
      <img src="images/guides/turn-3.png" alt="턴 시스템 3">
    </div>
  `
},
  {
...
},
{
  ...
  content: "이상낙원은 아직 진행중이라 제외."
},
{
  id: 12,
  category: "파밍",
  title: "유물, 행적 파밍 시 풀피 유지법",
  desc: "파밍하는데 피가 없어서 죽는 경우가 많아요. 어떻게 하면 풀피로 유지할 수 있나요?",
  buildImage: "images/guides/dat.png",
  content: `
    <p>
      유물, 행적 파밍 시<br>
      경계의 닻 근처에서 파밍을 진행하면<br>
      웨이브가 넘어갈 때마다 자동으로 회복시켜줍니다.
    </p>
  `
},
